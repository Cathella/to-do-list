...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _status_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./status.js */ \"./src/status.js\");\n\n\n\n\nclass Task {\n  constructor(index, description, completed) {\n    this.index = index;\n    this.description = description;\n    this.completed = completed;\n  }\n}\n\nwindow.onload = () => {\n  (0,_status_js__WEBPACK_IMPORTED_MODULE_1__.displayTasks)();\n};\n\n// add task event\ndocument.getElementById('form').addEventListener('submit', (e) => {\n  e.preventDefault();\n\n  const tasks = (0,_status_js__WEBPACK_IMPORTED_MODULE_1__.getTasks)();\n  const description = document.getElementById('description').value;\n  const completed = false;\n  const index = tasks.length;\n\n  const task = new Task(index, description, completed);\n  (0,_status_js__WEBPACK_IMPORTED_MODULE_1__.addTaskToList)(task);\n  (0,_status_js__WEBPACK_IMPORTED_MODULE_1__.addTask)(task);\n\n  e.target.reset();\n  return false;\n});\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
